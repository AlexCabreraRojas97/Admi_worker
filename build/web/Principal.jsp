...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="#">Reguistro de Asstencia</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active" style="border-radius: 10px;">
                        <a class="nav-link" href="Controlador?menu=Empleados&accion=Listar" target="miContenedor" style="border-radius: 10px; background-color: #808080; color: red;">Empleados</a>
                    </li>
